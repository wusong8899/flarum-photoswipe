...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('sycho/flarum-photoswipe', function () {
  ...
  components.forEach(function (prototype) {
    (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)(prototype, 'oninit', function () {
      this.lightbox = new photoswipe_lightbox__WEBPACK_IMPORTED_MODULE_4__["default"]({
